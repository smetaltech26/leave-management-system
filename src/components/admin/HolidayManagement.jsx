          ...
          <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
            ...
            <form onSubmit={handleSaveHoliday} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button type="submit" className="flex-1 py-3 bg-rose-500 hover:bg-rose-600 dark:bg-rose-500/20 dark:hover:bg-rose-500/30 dark:text-rose-300 dark:border dark:border-rose-500/40 text-white font-bold rounded-2xl flex items-center justify-center gap-2 shadow-sm active:scale-95 transition-all">
