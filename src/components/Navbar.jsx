      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActiveTab('home')}>
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-[var(--text-muted)] hidden sm:block">ระบบจัดการคำขอลางานออนไลน์ (S Metal Tech)</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-2xl bg-slate-100 dark:bg-[var(--card-bg)]/80 text-slate-600 dark:text-[var(--text-muted)] hover:bg-slate-200 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-[var(--card-border)] flex items-center space-x-1.5 text-xs font-semibold shadow-sm"
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-64 glass-card-clean-clean rounded-2xl py-2 shadow-2xl z-50 border border-slate-200 dark:border-[var(--card-border)]">
                <div className="px-4 py-3 border-b border-slate-200 dark:border-[var(--card-border)]">
                  ...
                  <p className="text-xs text-slate-500 dark:text-[var(--text-muted)] truncate">{currentUser?.email}</p>
